    ...
    return (
        <div id='hero' className='flex flex-col 2xl:flex-row lg:justify-between pt-5 p-4 mx-auto w-full max-w-[1900px] bg-neutral-900/10'>
            <div className='max-w-[600px] max-2xl:mx-auto p-4'>
                <SlideUpP className='text-3xl max-md:text-xl max-sm:text-lg pb-12 leading-[3rem]' delay={0}>
            ...
            <div className='max-w-[700px] max-2xl:mx-auto 2xl:p-4'>
                <SlideUpDiv className='w-full p-6 pb-8 bg-black max-2xl:mt-12 rounded-lg drop-shadow-[0_0px_10px_rgba(255,255,255,0.2)]' delay={0.9}>
                    ...
                    <div className='flex flex-col w-full text-md max-sm:text-xs'>
                        ...
                        <div className='w-full pt-4 inline-flex justify-between'>
                            <div>
                                Project Manager/Full-Stack Engineeer ∙ LabLabAI OpenAI Stack Hack
                            </div>
                            <div className='ml-4 min-w-[150px] max-sm:min-w-[70px]'>
                                2023
                            </div>
                ...
                <SlideUpDiv className='w-full p-6 pb-8 bg-black mt-12 rounded-lg drop-shadow-[0_0px_10px_rgba(255,255,255,0.2)]' delay={1.1}>
                    <div className='w-full'>
                        <SectionSeparator className='pt-0 mt-0'>
                            <p>Skills</p>
                        </SectionSeparator>
                ...
                <SlideUpDiv className='w-full p-6 pb-8 bg-black mt-12 rounded-lg drop-shadow-[0_0px_10px_rgba(255,255,255,0.2)]' delay={1.3}>
                    <div className='w-full'>
                        <SectionSeparator className='pt-0 mt-0'>
                    ...
                    <div className='flex flex-col w-full text-md max-sm:text-xs'>
                        ...
                        <div className='w-full pt-4 inline-flex justify-between'>
                            <div>
                                Busser/Food Runner ∙ FireRock SteakHouse
                            </div>
                            <div className='ml-4 min-w-[150px] max-sm:min-w-[70px]'>
                                2020—2022
                            </div>
