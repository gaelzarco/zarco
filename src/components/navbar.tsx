...
export default function NavBar() {
  ...
  return (
    <nav className={`${inter.className} sticky top-0 w-full flex items-center content-center justify-between px-4 max-md:p-1 bg-neutral-800/30 backdrop-blur-xl rounded-full p-4`}>
        ...
        <div className={`${inter.className} flex items-center content-center justify-between text-sm`}>
            <Link href="#about" className="hover:text-neutral-800 dark:hover:text-neutral-300 px-3 py-2 font-medium">About</Link>
